...
export default async function Video({ params }: PageProps) {
    ...
    if (data.status !== 200) {
        ...
        url: `https://bokepparty.pages.dev/v/${file.file_code}`,
        ...
        publisher: {
            '@type': 'Organization',
            name: `${SITENAME}`,
            logo: 'https://bokepparty.pages.dev/favicon.ico'},
            author: {
                '@type': 'Person',
                name: 'admin',
        ...
        interactionStatistic: {
            ...
            interactionType: {
                '@type': `ReadAction`,
                target: `https://bokepparty.pages.dev/v/${file.file_code}`
            }  
        }
        }
